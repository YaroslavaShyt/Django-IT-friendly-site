...
class PaymentForm(forms.Form):
    card_number = forms.CharField(label='Номер карти',
                                  widget=forms.TextInput(attrs={"class": "form-field",
                                                                'data-inputmask': "'mask': '9999 9999 9999 9999'"}))
    expire_date = forms.CharField(label='Термін дії',
                                  widget=forms.TextInput(attrs={"class": "form-field", 'data-inputmask': "'mask': '99/99'"}))
    cvv = forms.CharField(label='CVV',
                          widget=forms.TextInput(attrs={"class": "form-field", "data-inputmask": '"mask": "999"'}))
    full_name = forms.CharField(label="Ім'я та прізвище",
                                widget=forms.TextInput(attrs={"class": "form-field",
                                                              'id': 'name_surname',
                                                              'onkeyup': 'mask("name_surname");'}))
